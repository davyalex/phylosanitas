        ...
        <div class="card-body">
            ...
            <div class="row mb-3" id="optionSondage">
                <table class="table table-bordered" id="dynamicAddRemove" style="border:white">
                    <tr>
                        <th>
                            <label for="inputNumber" class="form-label">Définissez les options de reponse </label>
                        </th>
                    </tr>
                    <tr>
                        <td class="col-md-10"><input type="text" name="option[0][title]" placeholder="" class="form-control"
                                required />
                            <div class="invalid-feedback">Veuillez remplir ce champs</div>
                        </td>
                        <td class="col-md-2"><button type="button" name="add" id="add-btn" class="btn btn-success">+
                                Ajouter</button></td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    $("#add-btn").click(function() {
        ...
        $("#dynamicAddRemove").append('<tr><td><input type="text" name="option[' + i +
            '][title]" placeholder="" class="form-control" required /><div class="invalid-feedback">Veuillez remplir ce champs</div>           </td><td><button type="button" class="btn btn-danger remove-tr"><i class="bi bi-trash text-white"></i>Supprimer</button></td></tr>'
        );
    });
