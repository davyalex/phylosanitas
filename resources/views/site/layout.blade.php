...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P2HGDT42" height="0" width="0"
                                    ...
                                    <a href="/post/detail?slug={{ $item['slug'] }}"
                                        ...
                                        <div>
                                            <div class="post-meta d-block"><span
                                                    class="date">{{ $item['category']['title'] }}</span> <span
            ...
            <div class="container">
                ...
                <div class="row justify-content-between">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <div class="copyright">
                            Copyright © <?php echo date('Y'); ?> <strong><span>{{ config('app.name') }}</span></strong>.
