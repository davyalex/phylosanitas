         ...
         <div class="row">
            <div class="col-md-9" data-aos="fade-up">
               ...
               <div class="d-md-flex post-entry-2 half bg-white">
                  ...
                  @endif
                  <div>
                     <div class="post-meta"><span class="date">{{ $item['category']['title'] }}</span> <span
                        class="mx-1">&bullet;</span> <span style="font-style:italic">publié
                        {{ \Carbon\Carbon::parse($item['created_at'])->diffForHumans() }}</span>
                     </div>
                     <div class="post-meta d-flex justify-content-around ">
                        <h6 class="text-capitalize mr-auto"><i class="bi bi-eye"> </i>
                           {{ views($item)->count() }} vues
                        </h6>
                        <h6 class="text-capitalize "><i class="bi bi-chat-left-quote">
                           </i>{{ $item->commentaires->count() }} commentaires
                        </h6>
                     </div>
